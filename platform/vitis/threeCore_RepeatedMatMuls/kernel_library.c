...
static const u32 kernel_prefix_scan[] = {
    ...
    /* PC  4, 5 */ PACK(0xE034, 0x9501),       /* STRC R3, R4        | CONST R5, 1                */
    /* ===== SCAN STEP: OFFSET 1 ===== */
    /* PC  6, 7 */ PACK(0xA015, 0xB601),       /* CMP R1, R5         | BRzp +1                    */
    /* PC  8, 9 */ PACK(0x4615, 0x7760),       /* SUB R6, R1, R5     | LDR R7, R6                 */
    /* PC 10,11 */ PACK(0x3447, 0xC000),       /* ADD R4, R4, R7     | SYNC                       */
    /* PC 12,13 */ PACK(0xE034, 0x9502),       /* STRC R3, R4        | CONST R5, 2                */
    /* ===== SCAN STEP: OFFSET 2 ===== */
    /* PC 14,15 */ PACK(0xA015, 0xB601),       /* CMP R1, R5         | BRzp +1                    */
    /* PC 16,17 */ PACK(0x4615, 0x7760),       /* SUB R6, R1, R5     | LDR R7, R6                 */
    /* PC 18,19 */ PACK(0x3447, 0xC000),       /* ADD R4, R4, R7     | SYNC                       */
    /* PC 20,21 */ PACK(0xE034, 0x9504),       /* STRC R3, R4        | CONST R5, 4                */
    /* ===== SCAN STEP: OFFSET 4 ===== */
    /* PC 22,23 */ PACK(0xA015, 0xB601),       /* CMP R1, R5         | BRzp +1                    */
    /* PC 24,25 */ PACK(0x4615, 0x7760),       /* SUB R6, R1, R5     | LDR R7, R6                 */
    /* PC 26,27 */ PACK(0x3447, 0xC000),       /* ADD R4, R4, R7     | SYNC                       */
    /* PC 28,29 */ PACK(0xE034, 0x9508),       /* STRC R3, R4        | CONST R5, 8                */
    /* ===== SCAN STEP: OFFSET 8 ===== */
    /* PC 30,31 */ PACK(0xA015, 0xB601),       /* CMP R1, R5         | BRzp +1                    */
    /* PC 32,33 */ PACK(0x4615, 0x7760),       /* SUB R6, R1, R5     | LDR R7, R6                 */
    /* PC 34,35 */ PACK(0x3447, 0xC000),       /* ADD R4, R4, R7     | SYNC                       */
    /* PC 36,37 */ PACK(0xE034, 0x4D4C),       /* STRC R3, R4        | SUB R13, R4, R12           */
    /* ===== EXCLUSIVE SCAN ===== */
    /* PC 38,39 */ PACK(0x9310, 0xE03D),       /* CONST R3, 16       | STRC R3, R13               */
    /* ===== DONE ===== */
    /* PC 40,41 */ PACK(INSTR_DONE, INSTR_DONE),/* DONE              | DONE                      */
};
...
static const u32 kernel_stencil[] = {
    ...
    /* ===== LOAD CENTER (concurrent) AND LEFT ===== */
    /* PC  4, 5 */ PACK(0xD830, 0x4715),       /* LDC R8, R3         | SUB R7, R1, R5             */
    /* PC  6, 7 */ PACK(0x7970, 0xA010),       /* LDR R9, R7         | CMP R1, R0                 */
    /* ===== FIX LANE 0 ===== */
    /* PC  8, 9 */ PACK(0xB402, 0xBE02),       /* BRz +2             | BRnzp +2                   */
    /* PC 10,11 */ PACK(0x3980, 0xC000),       /* ADD R9, R8, R0     | SYNC                       */
    /* ===== LOAD RIGHT ===== */
    /* PC 12,13 */ PACK(0x3715, 0x7A70),       /* ADD R7, R1, R5     | LDR R10, R7                */
    /* PC 14,15 */ PACK(0xA01C, 0xB402),       /* CMP R1, R12        | BRz +2                     */
    /* ===== FIX LANE 15 ===== */
    /* PC 16,17 */ PACK(0xBE02, 0x3A80),       /* BRnzp +2           | ADD R10, R8, R0             */
    /* PC 18,19 */ PACK(0xC000, 0x3B98),       /* SYNC               | ADD R11, R9, R8             */
    /* ===== COMPUTE AND STORE ===== */
    /* PC 20,21 */ PACK(0x3BBA, 0xE04B),       /* ADD R11, R11, R10  | STRC R4, R11 (concurrent!) */
    /* ===== DONE ===== */
    /* PC 22,23 */ PACK(INSTR_DONE, INSTR_DONE),/* DONE              | DONE                      */
};
