...
module reg_file #(
    ...
    //Register 2 is always 16'(WARP_ID)
    always_comb begin
        if (raddr1 == 4'd0)      rdata1 = 16'h0;
        else if (raddr1 == 4'd1) rdata1 = 16'(LANE_ID);
        else if (raddr1 == 4'd2) rdata1 = 16'(WARP_ID);
    ...
    always_comb begin
        ...
        else if (raddr2 == 4'd2) rdata2 = 16'(WARP_ID);
